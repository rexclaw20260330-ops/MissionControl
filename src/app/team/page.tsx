...
const hierarchy = {
  master: {
    ...
    status: "online",
    device: "Mac Studio",
    description: "Founder & CEO. The architect and owner of the DinoSquad organization.",
    emoji: "👑",
  ...
  rex: {
    ...
    status: "online",
    device: "Cloud",
    description: "Primary AI assistant. Manages all tasks and coordinates with sub-agents to execute missions.",
    emoji: "🦖",
    gradient: "from-[#0066ff] to-[#00ffff]",
    icon: Bot,
  },
  agents: [
    { id: "tricera", name: "Tricera", role: "Art Director", type: "sub", status: "online", device: "Mac Studio", description: "Creative lead for all visual design, UI/UX, and brand identity projects across the squad.", emoji: "🦕", gradient: "from-purple-500 to-pink-500", icon: User },
    { id: "pteroda", name: "Pteroda", role: "Research Lead", type: "sub", status: "online", device: "Cloud", description: "Gathers information, analyzes market data, and provides research-backed insights for decision making.", emoji: "🦅", gradient: "from-amber-500 to-orange-500", icon: BookOpen },
    { id: "bronto", name: "Bronto", role: "QA Lead", type: "sub", status: "online", device: "Cloud", description: "Strategic thinker who validates deliverables, ensures quality standards, and breaks down complex projects into actionable steps.", emoji: "🦒", gradient: "from-emerald-500 to-teal-500", icon: Calendar },
    { id: "mosa", name: "Mosa", role: "Lead Engineer", type: "sub", status: "online", device: "MacBook Pro", description: "Code expert who builds features, fixes bugs, and maintains technical infrastructure for the entire organization.", emoji: "🐊", gradient: "from-rose-500 to-red-500", icon: Code },
  ],
};
